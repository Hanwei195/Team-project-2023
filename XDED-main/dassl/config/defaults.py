...
_C.DATALOADER.TRAIN_U.BATCH_SIZE = 16
...
_C.DATALOADER.TEST.BATCH_SIZE = 16
...
# CSKD
_C.TRAINER.XDED = CN()
_C.TRAINER.XDED.KD_TEMP = 4.
_C.TRAINER.XDED.REPLACE = False
_C.TRAINER.XDED.WARMUP = 1
_C.TRAINER.XDED.LAMBDA = 1.0
